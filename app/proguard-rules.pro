...
-keep class com.serndinfo.handsetypw.database.** {*;}
-dontwarn com.serndinfo.handsetypw.database.**
-keep class com.serndinfo.handsetypw.entitys.** {*;}
-dontwarn com.serndinfo.handsetypw.entitys.**
-keep class com.serndinfo.handsetypw.mpush.** {*;}
-dontwarn com.serndinfo.handsetypw.mpush.**
-keep class com.serndinfo.handsetypw.test.** {*;}
-dontwarn com.serndinfo.handsetypw.test.**
-keep class com.serndinfo.handsetypw.view.** {*;}
-dontwarn com.serndinfo.handsetypw.view.**
-keep class com.serndinfo.handsetypw.update.** {*;}
-dontwarn com.serndinfo.handsetypw.update.**
-keep class com.serndinfo.handsetypw.util.** {*;}
-dontwarn com.serndinfo.handsetypw.util.**
-keep class com.serndinfo.handsetypw.zxing.** {*;}
-dontwarn com.serndinfo.handsetypw.zxing.**
...
#-keepclasseswithmembers class com.demo.login.bean.ui.TlvMainActivity$JSInterface {
#      <methods>;
#}
